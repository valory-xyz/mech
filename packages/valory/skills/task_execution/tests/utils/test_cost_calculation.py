...
def _task(request_id: str = "req-1", **extra) -> dict:
...
class TestGetCostForDoneTask:
    ...
    def test_valid_cost_integer(self):
    ...
    def test_valid_cost_fractional_ceil(self, total_cost, expected):
