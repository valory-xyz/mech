    ...
    (_message.Message,),
    {
        "ErrorCode": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage.ErrorCode)
            },
        ),
        "Bytes_Performative": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "default_pb2"
                # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage.Bytes_Performative)
            },
        ),
            ...
            (_message.Message,),
            {
                "ErrorDataEntry": _reflection.GeneratedProtocolMessageType(
                    ...
                    (_message.Message,),
                    {
                        ...
                        "__module__": "default_pb2"
                        # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage.Error_Performative.ErrorDataEntry)
                    },
                ),
                "DESCRIPTOR": _DEFAULTMESSAGE_ERROR_PERFORMATIVE,
                "__module__": "default_pb2"
                # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage.Error_Performative)
            },
        ),
        "End_Performative": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "default_pb2"
                # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage.End_Performative)
            },
        ),
        "DESCRIPTOR": _DEFAULTMESSAGE,
        "__module__": "default_pb2"
        # @@protoc_insertion_point(class_scope:aea.valory.default.v1_0_0.DefaultMessage)
    },
)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _DEFAULTMESSAGE._serialized_start = 45
    _DEFAULTMESSAGE._serialized_end = 861
    _DEFAULTMESSAGE_ERRORCODE._serialized_start = 297
    _DEFAULTMESSAGE_ERRORCODE._serialized_end = 524
    _DEFAULTMESSAGE_ERRORCODE_ERRORCODEENUM._serialized_start = 397
    _DEFAULTMESSAGE_ERRORCODE_ERRORCODEENUM._serialized_end = 524
    _DEFAULTMESSAGE_BYTES_PERFORMATIVE._serialized_start = 526
    _DEFAULTMESSAGE_BYTES_PERFORMATIVE._serialized_end = 563
    _DEFAULTMESSAGE_ERROR_PERFORMATIVE._serialized_start = 566
    _DEFAULTMESSAGE_ERROR_PERFORMATIVE._serialized_end = 825
    _DEFAULTMESSAGE_ERROR_PERFORMATIVE_ERRORDATAENTRY._serialized_start = 777
    _DEFAULTMESSAGE_ERROR_PERFORMATIVE_ERRORDATAENTRY._serialized_end = 825
    _DEFAULTMESSAGE_END_PERFORMATIVE._serialized_start = 827
    _DEFAULTMESSAGE_END_PERFORMATIVE._serialized_end = 845
